...
class AirConditionerControlUnit extends StatefulWidget {
  @override
  _AirConditionerControlUnitState createState() =>
      _AirConditionerControlUnitState();
}

class _AirConditionerControlUnitState extends State<AirConditionerControlUnit>
...
List<Widget> tabContainWidget(List<HomeInfoModel> infoData, bool isPortrait) {
  ...
  for (var i = 0; i < infoData.length; ++i) {
    tabList.add(Container(
        ...
        child: isPortrait
            ? PortraitAirConditionerUnit(i)
            : LandScapeAirConditionerUnit(i)));
  }
                        ...
                        Transform.rotate(
                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              child: CustomPaint(
                                painter:
                                    TickPainter(currentTem: roomData.setTemp),
                              ),
                            ),
                          ),
                        ),
